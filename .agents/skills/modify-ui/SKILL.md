...
ACTION 3: Read .Codex/components/registry.json → check available components
...
- For animations: use Framer Motion (read `.Codex/knowledge/libraries/framer-motion.md`)
...
5. Reference: .Codex/knowledge/patterns/design-system.md for token presets

## Animation Changes

When the user asks to add/change animations:
1. Read .Codex/knowledge/libraries/framer-motion.md for animation patterns
