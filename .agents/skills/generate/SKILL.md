...
ACTION 3: Read .Codex/knowledge/index.json → find the knowledge file for the generation type
```
...
Read the matching knowledge file from `.Codex/knowledge/`.
...
- Reference: .Codex/knowledge/patterns/ui-ux-principles.md
